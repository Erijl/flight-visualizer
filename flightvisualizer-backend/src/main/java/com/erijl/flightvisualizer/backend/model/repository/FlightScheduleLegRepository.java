...
public interface FlightScheduleLegRepository extends CrudRepository<FlightScheduleLeg, Integer> {
    ...
    @Query("SELECT new com.erijl.flightvisualizer.backend.model.dto.FlightScheduleLegDto(fsl.legId, fsl.flightSchedule.flightScheduleId, fsl.originAirport, fsl.destinationAirport, fsl.aircraftDepartureTimeUtc, fsl.aircraftDepartureTimeDateDiffUtc, fsl.aircraftArrivalTimeUtc, fsl.aircraftArrivalTimeDateDiffUtc) " +
